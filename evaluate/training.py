...
flags.DEFINE_bool("do_export", False, "Whether to run export tf.estimator as saved_model.")
...
def main(): 
  ...
  if FLAGS.do_predict:
    ...
    ans =  get_predictions(eval_examples, eval_features, all_results,
                      FLAGS.n_best_size, FLAGS.max_answer_length,
                      FLAGS.do_lower_case)
    print("This is my ANSWER : {}".format(ans['a']))

if __name__ == "__main__":    
  os.system('clear')
  s1 = input('\nPlease enter the directory path to the corpus 1: ') 
  s2 = input('\nPlease enter the directory path to the corpus 2: ') 
  with open(s1 + ".txt", 'r') as myfile:
    corpus1 = myfile.read().replace('\n', ' ')
  with open(s2 + ".txt", 'r') as myfile:
    corpus2 = myfile.read().replace('\n', ' ')
  corpus = corpus1
  os.system('clear')
  print('\n',corpus1)
  print("\n+++You are working on copus1. If you want to choice what corpus you work with, please enter 'corpus1' or 'corpus2' instead of entering question+++")
  while True:
    question = input('\nAsk me a QUESTION : ')
    if question == '':
      pass
